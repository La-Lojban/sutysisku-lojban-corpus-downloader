...
import { Tensor, Session, Encoder, GeneratorType } from '../common/index.js';
...
import { createSession, loadTokenizer } from '../browser/index.js';
...
export class FeatureExtractionModel extends BaseTextModel {
  ...
  process = async (inputs: string | string[]): Promise<FeatureExtractionResult> => {
